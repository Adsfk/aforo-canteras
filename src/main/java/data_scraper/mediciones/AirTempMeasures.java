...
public class AirTempMeasures {
    ...
    public AirTempMeasures() {
        this.request = new PostRequest("https://portus.puertos.es/Portus_RT/portusgwt/rpc",
                ...
                "7|0|6|https://portus.puertos.es/Portus_RT/portusgwt/|4763486D406A92423D6F43998BCFC0EF|es.puertos.portus.main.client.service.PortusService|requestData|I|Z|1|2|3|4|4|5|5|5|6|2442|62|0|1|");
    }

    public double getMeasures(){
        String response = request.getResponse();
        String[] lines = response.split(DELIMITER);
        return DataExtractor.extract_data(lines, EXPECT, MAX_ROW, TARGET_ROW);
    }
}
